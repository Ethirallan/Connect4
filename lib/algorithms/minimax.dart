...
Move miniMax(List<List<int>> board, int n, int m, int depth, bool maximizingPlayer, int player) {
  ...
  if (depth == 0 || isTerminal) {
    ...
    for (int col in openCols) {
      ...
      Move possibleMove = miniMax(clone, n, m, depth - 1, false, player);
    ...
    for (int col in openCols) {
      ...
      Move possibleMove = miniMax(clone, n, m, depth - 1, true, player);
      if (possibleMove.score < bestMove.score) {
        bestMove.score = possibleMove.score;
        bestMove.col = col;
      }
